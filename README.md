...
- [ ] Java 코드 컨벤션을 준수하였는가?
  ...
  - [ ] 줄바꿈 확인
  - [ ] 주석 확인
- [ ] 랜덤 값 추출에 `camp.nextstep.edu.missionutils.Randoms`의 `pickNumberInRange()`를 사용했는가?
- [ ] 사용자 입력값을 읽을 때 `camp.nextstep.edu.missionutils.Console`의 `readLine()`을 활용했는가?